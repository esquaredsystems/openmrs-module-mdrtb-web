...
urlpatterns = [
    ...
    path('<str:mdrtb>dashboard/patient/<str:uuid>', views.patient_dashboard, name='mdrdashboard'),
    ...
    path('enrolledprograms' , views.enrolled_programs,name='enrolledprograms'),
    ...
    path('commonlab/labtest/<str:testid>/editattributes/<str:attrid>' , views.editAttribute,name='editattr'),
