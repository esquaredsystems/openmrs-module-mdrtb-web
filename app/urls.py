...
urlpatterns = [
    ...
    path("tbdashboard/patient/<str:uuid>", views.render_patient_dashboard, name="dashboard"),
    path("<str:mdrtb>/dashboard/patient/<str:uuid>", views.render_patient_dashboard, name="mdrdashboard"),
    path("report", views.index, name="report"),
    path("enrollpatient", views.render_enroll_patient, name="enrollPatient"),
    path("editpatient/<str:uuid>", views.render_edit_patient, name="editpatient"),
    path("patient/<str:uuid>/dotsprogramenroll", views.render_enroll_in_dots_program, name="dotsprogramenroll"),
    path("patient/<str:uuid>/mdrtbprogramenrollment", views.render_enroll_patient_in_mdrtb, name="mdrtbprogramenroll"),
    path("patient/<str:uuid>/editdotsprogram/<str:programid>", views.render_edit_dots_program, name="editdotsprogram"),
    path("patient/<str:uuid>/editmdrtbprogram/<str:programid>", views.render_edit_mdrtb_program, name="editmdrtbprogram"),
    path("patient/<str:uuid>/enrolledprograms", views.render_enrolled_programs, name="enrolledprograms"),
    path("patient/<str:patientuuid>/transferout", views.render_transferout_form, name="transferout"),
    path("patient/<str:patientuuid>/transferout/<str:formid>", views.render_edit_transferout_form, name="edittransferout"),
    path("transferout/<str:formid>", views.render_delete_transferout_form, name="deletetransferout"),
    path("patient/<str:patientid>/drugresistense", views.render_drug_resistence_form, name="drugresistanse"),
    path("patient/<str:patientid>/drugresistense/<str:formid>", views.render_edit_drug_resistence_form, name="editdrugresistanse"),
    path("drugresistense/<str:formid>", views.render_delete_drug_resistence_form, name="deletedrugresistanse"),
    ...
    path(
        "reportqueue/<str:job_id>/status",
        views.report_queue_status,
        name="reportqueuestatus",
    ),
    path(
        "reportqueue/<str:job_id>/view",
        views.report_queue_view,
        name="reportqueueview",
    ),
    path(
        "tb03results",
        views.report_queue_entry,
        {"view_key": "tb03results"},
        name="tb03Results",
    ),
    path(
        "tb03singleresults",
        views.report_queue_entry,
        {"view_key": "tb03singleresults"},
        name="tb03singleResults",
    ),
    path(
        "tb03usingleresults",
        views.report_queue_entry,
        {"view_key": "tb03usingleresults"},
        name="tb03usingleResults",
    ),
    path(
        "missingtb03results",
        views.report_queue_entry,
        {"view_key": "missingtb03results"},
        name="missingtb03results",
    ),
    path(
        "missingtb03uresults",
        views.report_queue_entry,
        {"view_key": "missingtb03uresults"},
        name="missingtb03uresults",
    ),
    path(
        "form8results",
        views.report_queue_entry,
        {"view_key": "form8results"},
        name="form8Results",
    ),
    path(
        "tb07results",
        views.report_queue_entry,
        {"view_key": "tb07results"},
        name="tb07results",
    ),
    path(
        "tb03uresults",
        views.report_queue_entry,
        {"view_key": "tb03uresults"},
        name="tb03uResults",
    ),
    path(
        "form89results",
        views.report_queue_entry,
        {"view_key": "form89results"},
        name="form89results",
    ),
    path(
        "tb08results",
        views.report_queue_entry,
        {"view_key": "tb08results"},
        name="tb08results",
    ),
    path(
        "tb08uresults",
        views.report_queue_entry,
        {"view_key": "tb08uresults"},
        name="tb08uresults",
    ),
    path(
        "tb07uresults",
        views.report_queue_entry,
        {"view_key": "tb07uresults"},
        name="tb07uresults",
    ),
    path(
        "dotsdqresults",
        views.report_queue_entry,
        {"view_key": "dotsdqresults"},
        name="dotsdqresults",
    ),
    path(
        "mdrdqresults",
        views.report_queue_entry,
        {"view_key": "mdrdqresults"},
        name="mdrdqresults",
    ),
    path(
        "adverseeventsregister",
        views.report_queue_entry,
        {"view_key": "adverseeventsregister"},
        name="adverseeventsregister",
    ),
    path(
        "quarterlyae",
        views.report_queue_entry,
        {"view_key": "quarterlyae"},
        name="quarterlyae",
    ),
